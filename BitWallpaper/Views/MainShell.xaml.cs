...
public sealed partial class MainShell : Page
{
    ...
    */
            ...
            if (App.MainWindow != null && xdoc.Root != null)
            {
                ...
                if (opts != null)
                {
                    ...
                    if (xvalue != null)
                    {
                        ...
                        {
                            MainVM.IsChartTooltipVisible = xvalue.Value == "True";
                        }
                    }
                    ...
                    if (xvalue != null)
                    {
                        if (!string.IsNullOrEmpty(xvalue.Value))
                        {
                            MainVM.IsDebugSaveLog = xvalue.Value == "True";
                        }
                    }
                }
                    ...
                    foreach (var hoge in pairList)
                    {
                        ...
                        if (xvalue != null)
                        {
                            if (!string.IsNullOrEmpty(xvalue.Value))
                            {
                                try
                                {
                                    var pc = MainVM.GetPairs[xvalue.Value];
    ...
    private void OnLoaded(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
    {
        if (App.MainWindow is not null)
        {
            TitleBarHelper.UpdateTitleBar(ElementTheme.Default, App.MainWindow);
        }
